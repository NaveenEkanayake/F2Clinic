  ...
  return (
    <ol className="relative text-gray-500 border-s border-gray-200 dark:border-gray-700 dark:text-gray-400">
      <li className="mb-10 ms-6">
        ...
        <h3 className="font-medium leading-tight">Update Pet Record Info</h3>
        <p className="text-sm">Add your Updated Info here!!! .</p>
      </li>
      <li className="mb-10 ms-6">
...
export default UpdatePetRecordSVG;
