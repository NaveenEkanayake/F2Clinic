...
import {
  verifyconsultant,
  getAllConsultantNotifications,
  ISReadAllNotifications,
} from "@/Api/config";

const ConsultantNotificationContent = ({
  isSidebarOpen,
  ...
  useEffect(() => {
    const fetchNotifications = async () => {
      try {
        const UserResponse = await verifyconsultant();
        if (!UserResponse) {
          console.error("Consultant verification failed.");
          return;
        }

        const results = await getAllConsultantNotifications();
...
export default ConsultantNotificationContent;
