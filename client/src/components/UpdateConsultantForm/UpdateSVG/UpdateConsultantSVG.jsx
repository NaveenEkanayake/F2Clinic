  ...
  return (
    <ol className="relative text-gray-500 border-s border-gray-200 dark:border-gray-700 dark:text-gray-400">
      <li className="mb-10 ms-6">
        ...
        <h3 className="font-medium leading-tight">Consultant Info</h3>
        <p className="text-sm">
          Enter the Updating Consultant Details here !!!!
        </p>
      </li>
      <li className="mb-10 ms-6">
...
export default UpdateConsultantSVG;
